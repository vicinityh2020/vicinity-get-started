...
* Go to the organisation profile and `give new roles to your user <https://github.com/vicinityh2020/vicinity-neighbourhood-manager/wiki/User-management>`_. For simplicity, grant all the roles and you will get full power over your organisation. It is possible to have different users having different roles and responsibilities, to learn more go to the `user properties section <https://github.com/vicinityh2020/vicinity-neighbourhood-manager/wiki/User-properties>`_.
