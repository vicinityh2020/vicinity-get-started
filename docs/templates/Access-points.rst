...
* Gateway: Software that is used to communicate with the platform's communication server and the P2P network. See all information regarding the VICINITY Open Gateway `HERE <https://github.com/vicinityh2020/vicinity-neighbourhood-manager/blob/master/TBD>`_
